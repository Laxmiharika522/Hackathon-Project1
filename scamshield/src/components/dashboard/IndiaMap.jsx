...
export default function IndiaMap() {
  ...
  return (
    <div className="relative bg-white/[0.02] backdrop-blur-xl border border-white/5 rounded-[2rem] flex flex-col shadow-2xl min-h-[500px]">
      ...
      <div className="flex items-center gap-3 px-8 pt-6 pb-0">
        ...
        <h2 className="text-xl font-black text-white tracking-tight">Live Threat Radar</h2>
      </div>
      ...
      {/* Sidebar Details */}
      <div className="w-full md:w-72 bg-[#0a0a0a] border-l border-white/5 p-8 flex flex-col z-10 shadow-[-10px_0_30px_rgba(0,0,0,0.5)]">
        <h3 className="text-xs font-black text-gray-600 uppercase tracking-[0.2em] mb-8">Region Inspector</h3>
        ...
        {selectedState ? (
          <div className="animate-[fadeIn_0.3s_ease-in-out]">
             <div className="flex items-center gap-3 mb-8">
               ...
               <h2 className="text-3xl font-black text-white tracking-tight">{selectedState.name}</h2>
             </div>
             
             <div className="bg-[#111] rounded-2xl p-5 border border-white/5 mb-5 shadow-inner">
                <p className="text-[10px] text-gray-500 uppercase font-black tracking-widest mb-1.5">Threat Level</p>
             ...
             <div className="bg-[#111] rounded-2xl p-5 border border-white/5 mb-5 shadow-inner">
                <p className="text-[10px] text-gray-500 uppercase font-black tracking-widest mb-1.5">Reports Today</p>
                <p className="text-4xl font-black text-white">{selectedState.fraudCount}</p>
             </div>

             <div className="bg-[#111] rounded-2xl p-5 border border-white/5 shadow-inner">
                <p className="text-[10px] text-gray-500 uppercase font-black tracking-widest mb-2">Top Active Scam</p>
                <p className="text-sm font-bold text-red-400">{selectedState.topScam}</p>
             </div>
          </div>
        ) : (
          <div className="flex-1 flex flex-col items-center justify-center text-center opacity-40">
            <svg className="w-16 h-16 text-gray-600 mb-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1" d="M15 15l-2 5L9 9l11 4-5 2zm0 0l5 5M7.188 2.239l.777 2.897M5.136 7.965l-2.898-.777M13.95 4.05l-2.122 2.122m-5.657 5.656l-2.12 2.122"></path></svg>
            <p className="text-sm font-medium text-gray-400 max-w-[200px]">Select a region on the map to intercept live threat telemetry.</p>
          </div>
        )}
      </div>
